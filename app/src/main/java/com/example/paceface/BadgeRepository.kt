...
class BadgeRepository(context: Context) {
    ...
    suspend fun checkAndAwardBadges(userId: Int, passedUserId: Int) {
        ...
        if (proximityWithUserCount >= 2 && !userBadges.contains(9)) {
        ...
        if (happyProximityCount >= 5 && !userBadges.contains(10)) {
